...
<form class="form-horizontal" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="address" placeholder="555 Easy Street">
    </div>
    <label for="aptnumber" class="col-sm-1 control-label">Apt No.</label>
    <div class="col-sm-3">
      <input type="password" class="form-control" id="aptnumber" placeholder="#555">
    </div>
  </div>
  <div class="form-group">
    <label for="state" class="col-sm-1 control-label">Select State</label>
    <div class="col-sm-4">
  ...
  <div class="form-group">
    <div class="col-sm-offset-1 col-sm-10">
	    <button type="submit" class="btn btn-default">JK. Go Back.</button>
